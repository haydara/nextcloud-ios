...
@objc class NCBrandOptions: NSObject {
    ...
    @objc public var brand: String = "Smartwork"
    @objc public var textCopyrightNextcloudiOS: String = "Smartwork for iOS %@ © 2022"
    @objc public var textCopyrightNextcloudServer: String = "Smartwork Server %@"
    @objc public var loginBaseUrl: String = "https://smartwork.salvia-gebaeudetechnik.de/"
...
class NCBrandColor: NSObject {
    ...
    // Color
    @objc public let customer: UIColor = UIColor(red: 0.0/255.0, green: 52.0/255.0, blue: 89.0/255.0, alpha: 1.0)     // BLU NC : #0082c9
    ...
    @objc public let nextcloud: UIColor = UIColor(red: 0.0/255.0, green: 52.0/255.0, blue: 89.0/255.0, alpha: 1.0)
